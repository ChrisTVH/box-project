...
complete -c box-rpg -n '__fish_seen_subcommand_from runtime' -a 'list available install remove'
complete -c box-rpg -n '__fish_seen_subcommand_from available' -l page -d 'Select a five-version page'
complete -c box-rpg -n '__fish_seen_subcommand_from available' -l interactive -d 'Select and install a version'
